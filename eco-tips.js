const advices = [
    ...
    { number: "12", title: "احذر من الإعلانات المغرية", description: "تجنب الانجرار خلف الإعلانات المغرية، خصوصاً على الإنترنت. فكر دائماً قبل الشراء إذا كنت فعلاً تحتاج المنتج أو الخدمة" },
    { number: "13", title: "استبدل الأنشطة المكلفة بأنشطة مجانية", description: "بدلاً من زيارة السينما أو أماكن الترفيه باهظة الثمن، حاول تتابع أفلام أو مسلسلات في المنزل، أو استمتع بأنشطة مجانية في الجامعة" },
